//JAVAFX DISPLAY TEXT
//Displays "Welcome to Java" in a circular pattern in Javafx using the properties of a circle.
//Uses the radius and the center point of the pane/center point of the circle, to orient
//each letter in the string to the correct position and rotation by using a for loop.
...
public class JavaFXDisplayTextTest extends Application {
