...
//Allows the user select one of three lights: red, yellow, or green. 
//When a  radio button is selected, the light is turned on. Only one 
...
public class TrafficLightManager extends Application { 
