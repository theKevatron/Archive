...
//Displays a rectangle centered in the scene, with a button in the center bottom. 
//Clicking the button rotates the rectangle 15 degrees. Uses a class called 
//RotateHandlerClass derived from the EventHandler class which handles the 
//pushing button event(which rotates the rectangle 15 degrees and sets the new value of r as r+15).
...
public class JavaFXEventHandlingTest extends Application {
