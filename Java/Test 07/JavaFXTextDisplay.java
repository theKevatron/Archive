//JAVAFX TEXT DISPLAY
//Displays 5 texts vertically set in Times Roman font,
//in bold italics 22 size font, each with a random color and opacity. 
 
/*
Technical Description:
This program declares an HBox, and the 5 text objects are 
placed in the HBox. The HBox is put in a scene, 
the scene is put in a stage, and the stage is displayed.
*/
...
public class JavaFXTestDisplay extends Application {
